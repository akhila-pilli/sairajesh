...
public class gift {
	...
	public static void main(String[] args)
	{
		...
		String s[]= {"fivestar","kalakand","kajubarfi","temptation"};
		int[] a = new int[4];
        char n1;
        sweets collect;
        Boolean n=true;
        ...
        while(n)
        {
        	...
        	System.out.println("2.kalakand");
        	System.out.println("3.kajubarfi");
        	System.out.println("4. temptation");
        	System.out.println("Select from the above sweets");
        	switch(sc.next().charAt(0))
        	{
        	case '1': System.out.println("Enter the quantity of fivestar: ");
        			  qnt=sc.nextInt();
        	...
        	case '2': System.out.println("Enter the quantity of kalakand: ");
			  qnt=sc.nextInt();
			  System.out.println("Enter the weight in grams: ");
			  wt=sc.nextInt();
			  collect= new kalakand();
			  total_weight=collect.totalwt( qnt, wt);
			  a[1]+=qnt*wt;
			  totwt=0;
			  totalbox_wt=totalbox_wt+total_weight;
        ...
        case '4': System.out.println("Enter the quantity of temptation: ");
		  qnt=sc.nextInt();
		  System.out.println("Enter the weight in grams: ");
		  wt=sc.nextInt();
		  collect= new temptation();
		  total_weight=collect.totalwt( qnt, wt);
		  a[3]+=qnt*wt;
		  totwt=0;
		  totalbox_wt=totalbox_wt+total_weight;
